...
'''
result = fs.f_classif(train_df[all_columns], train_df['SalePrice'])
res_df = pd.DataFrame()
res_df['FEATURES'] = all_columns
res_df['F-VALUES'] = result[0][:]
res_df['P-VALUES'] = result[1][:]

resp_df = res_df[['FEATURES', 'P-VALUES']].sort_values('P-VALUES', ascending = True)
ax2 = resp_df.plot.bar(x = 'FEATURES', y = 'P-VALUES', figsize = (16, 10))
ax2.set_title('P-VALUES')

print("============= P - VALUE Features Selection =============")
print("============= Important Feaures are P -values < 0.05 =============")
print(resp_df)
