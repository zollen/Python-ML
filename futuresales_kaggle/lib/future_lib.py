...
def add_date_shop_type_avg_cnt(method, tokens, src, train, test):
    ...
    train.fillna(0, inplace = True)
    test = test.merge(f1, on=['date_block_num', 'shop_id', 'item_type'], how='left')
    test.fillna(0, inplace = True)    
    tokens.append('date_shop_type_avg_cnt')
    del f1
    return train, test
...
def add_date_name3_avg_cnt(method, tokens, src, train, test):
    ...
    train.fillna(0, inplace = True)
    test = test.merge(f1, on=['date_block_num', 'name3'], how='left')
    test.fillna(0, inplace = True)    
    tokens.append('date_name3_avg_cnt')
    del f1
    return train, test
...
def add_date_type_name3_avg_cnt(method, tokens, src, train, test):
    ...
    train.fillna(0, inplace = True)
    test = test.merge(f1, on=['date_block_num', 'item_type', 'name3'], how='left')
    test.fillna(0, inplace = True)    
    tokens.append('date_type_name3_avg_cnt')
    del f1
    return train, test
...
def add_date_cat_name3_avg_cnt(method, tokens, src, train, test):
    ...
    train.fillna(0, inplace = True)
    test = test.merge(f1, on=['date_block_num', 'item_category_id', 'name3'], how='left')
    test.fillna(0, inplace = True)    
