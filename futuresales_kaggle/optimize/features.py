...
def evaluate(trial, tokens, df):
    ...
    params = []
    actions = []
    for i in range(1, numOfParams + 1):
    ...
    lags = [ 'date_avg_cnt', 'date_shop_avg_cnt', 'date_item_avg_cnt', 'date_shop_item_avg_cnt' ]
    removals = [ 'date_avg_cnt', 'date_shop_avg_cnt', 'date_item_avg_cnt', 'date_shop_item_avg_cnt' ]
