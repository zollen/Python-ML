...
all_df['Age'] = all_df['Age'].astype('int32')
...
all_df['Embarked'] = all_df['Embarked'].map(embarkeds)


train_df['Cabin'] = train_df['Cabin'].map(cabins)
test_df['Cabin'] = test_df['Cabin'].map(cabins)
all_df['Cabin'] = all_df['Cabin'].map(cabins)
...
tbl = {
    "Title": all_df['Title'].unique(),
    "Age": all_df['Age'].unique(),
    "Sex": all_df['Sex'].unique(),
    "Pclass": all_df['Pclass'].unique(),
    "Cabin": all_df['Cabin'].unique(),
    "Size": all_df['Size'].unique(),
    "Fare": all_df['Fare'].unique(),
    "Embarked": all_df['Embarked'].unique()    
    }
